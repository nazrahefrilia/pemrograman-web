...
?>
   ...
   <link href='http://fonts.googleapis.com/css?family=Open+Sans' rel='styleshhtml' type='text/css' />
</head>
<body>
    <div id="wrapper">
           ...
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li  >
                        <a class="active-menu"  href="form.php"><i class="fa fa-edit fa-3x"></i> Tambah User </a>
                    </li>				
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form role="form">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" placeholder="Ketik disini" />
